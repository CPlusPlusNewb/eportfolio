...
**Security notes:** The server logs client IP addresses on each request, providing a basic audit trail of who accessed the file system.The index changes when the user refreshes the page and if the code has actually changed on the "back-end"
